...
def drawicons(frame):
	    ...
	    print 'draw icons'
            ...
            for icon in icons:
                ...
                frame.canvas.create_text(px[i],py[i]+120,text=names[i], anchor='nw', fill='white', width=isize)
                i=i+1
...
class Launcher(Frame):
    ...
    def onresize(self, event):
        ...
        calcpos(width)
        self.canvas.config(scrollregion=(0,0,300, (rows+1)*isize))
        drawicons(self)
